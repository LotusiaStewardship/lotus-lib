...
describe('MuSig2 Session Manager', () => {
  ...
  describe('Nonce Exchange', () => {
    it('should receive nonces from other signers', () => {
      ...
      manager.receiveNonce(aliceSession, 1, bobNonces)
    ...
    it('should reject nonce from self', () => {
      ...
      assert.throws(() => {
        manager.receiveNonce(aliceSession, 0, aliceNonces)
    ...
    it('should check hasAllNonces correctly', () => {
      ...
      manager.receiveNonce(aliceSession, 2, carolNonces)
  ...
  describe('Partial Signature Exchange', () => {
    it('should receive and verify partial signatures', () => {
      ...
      manager.receiveNonce(aliceSession, 1, bobNonces)
      manager.receiveNonce(bobSession, 0, aliceNonces)
  ...
  describe('Complete Flow', () => {
    ...
    it('should complete 3-of-3 signing session', () => {
      ...
      manager.receiveNonce(aliceSession, 2, carolNonces)
      manager.receiveNonce(bobSession, 0, aliceNonces)
      manager.receiveNonce(bobSession, 2, carolNonces)
      manager.receiveNonce(carolSession, 0, aliceNonces)
      manager.receiveNonce(carolSession, 1, bobNonces)
